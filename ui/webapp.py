...
DEFAULT_QUESTION_AT_STARTUP = os.getenv("DEFAULT_QUESTION_AT_STARTUP", "Moma-AI гэж юу вэ?")
...
def main():
    ...
    # Title
    st.write("# Mobicom operation manual 🚀")
    st.markdown(
        """



Moma-AI ямар ч асуулт асууж, зөв хариултаа олж аваарай!

Анхаарна уу: Түлхүүр үг ашиглахгүй, харин бүрэн хэмжээний асуултууд асуугаарай. Демо нь түлхүүр үгийн асуулгатай ажиллахад оновчтой биш бөгөөд таныг буруугаар ойлгож магадгүй.
""",
